...
http://opensource.kayac.com/projects/ark/#download

より、最新版をダウンロードし、展開します。

例：

    $ wget http://opensource.kayac.com/projects/ark/releases/Ark-0.01.tar.gz
...
L<チュートリアル|Ark::Manual::Tutorial>にすすみ実際にアプリケーションを作成してみてください。
